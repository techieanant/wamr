...
vi.mock('../../../src/models/conversation-session.model.js', () => ({
  ...
  serializeAvailableSeasons: vi.fn((seasons) => JSON.stringify(seasons)),
  deserializeAvailableSeasons: vi.fn((seasons) => (seasons ? JSON.parse(seasons) : null)),
  serializeSelectedSeasons: vi.fn((seasons) => JSON.stringify(seasons)),
  deserializeSelectedSeasons: vi.fn((seasons) => (seasons ? JSON.parse(seasons) : null)),
}));
